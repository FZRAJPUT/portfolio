  ...
  const experiences = [
    {
      ...
      company: "Ansh Info Tech",
      period: "June 2025 - Sept 2025",
      location: "Ludhiana, India",
      achievements: [
        "Developed a full-stack web application to streamline employee management, product inventory, and customer order tracking.",
        "Designed a MongoDB database schema to manage employees, product categories, stock levels, and customer orders.",
        "Integrated an order management module allowing staff to create, update, and track customer orders, reducing manual errors.",
        "Added real-time inventory updates so product stock automatically adjusts when orders are placed or fulfilled."
      ],
    },
    {
      title: "Full Stack Developer",
      ...
      location: "Remote",
      achievements: [
        "Contributed to the JIT University website and service-provider platforms.",
